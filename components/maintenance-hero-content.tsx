...
export default function MaintenanceHeroContent() {
  ...
  return (
    <div className="absolute inset-0 px-4 sm:px-6" data-hero-blend="true">
      ...
      >
        {t("Maintenances & services", "Maintenance & services")}
      </motion.h1>
      ...
      >
        <a href="/maintenances-services#types-maintenance" className="w-full sm:w-auto">
          <motion.button 
            className="bg-[#E9F8F9] text-black rounded-sm border border-white btn-effect-5 btn-standard w-full whitespace-nowrap mix-blend-difference"
            whileHover={{ scale: 1.02, y: 0}}
            whileTap={{ scale: 0.95 }}
            transition={{ duration: 0.2 }}
          >
            {t("Contrats maintenance", "Maintenance agreements")}
          </motion.button>
        </a>
        <a href="/maintenances-services#secteurs" className="w-full sm:w-auto">
          <motion.button 
            className="bg-transparent rounded-sm border border-white btn-effect-5 btn-standard w-full whitespace-nowrap mix-blend-difference"
            whileHover={{ scale: 1.02, y: 0 }}
            whileTap={{ scale: 0.95 }}
            transition={{ duration: 0.2 }}
          >
            {t("Nos secteurs", "Industries we serve")}
          </motion.button>  
        </a>
      </motion.div>
    </div>
