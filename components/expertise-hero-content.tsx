  ...
  return (
    <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-6">
      <div className="text-center max-w-5xl mx-auto">
        ...
        >
          Des solutions sur mesure en climatisation et froid industriel, 
          pensées pour durer et optimisées pour l'excellence énergétique.
        </motion.p>
        ...
        >
          <motion.button 
            className="px-8 py-4 bg-[#E9F8F9] text-black font-medium text-sm rounded-sm transition-all duration-500 hover:bg-[#537FE7]/90 hover:text-[#E9F8F9] cursor-pointer"
